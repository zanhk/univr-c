// implementare un programma che, dato un array di valori interi, con dimensione fissata e parametrica, esegua lo shift a destra dei valori, con rotazione dell'ultimo valore.
